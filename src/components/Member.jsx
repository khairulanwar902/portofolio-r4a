...
const MEMBERS = [
  ...
  { id: 5,  name: 'Sultan Buana Dirgantara',    role: 'Anggota',     color: 'from-emerald-500 to-teal-600',  photo: '/foto-sultan.jpeg' },
  { id: 6,  name: 'Cassiopeia Azzah',           role: 'Anggota',     color: 'from-pink-500 to-rose-600',     photo: '/foto-cassiopeia.jpeg' },
  { id: 7,  name: 'Darell Kastara Abiansyah',   role: 'Anggota',     color: 'from-fuchsia-500 to-pink-600',  photo: '/foto-darell.jpeg' },
  { id: 8,  name: 'Muhammad Farhan Abdillah',   role: 'Anggota',     color: 'from-orange-500 to-amber-600',  photo: '/foto-farhan.jpeg' },
  { id: 9,  name: 'Nur Indah Sapitri',          role: 'Anggota',     color: 'from-teal-500 to-cyan-600',     photo: '/foto-nur-indah.jpeg' },
  { id: 10, name: 'Nisrina Nurhaliza Zufri',    role: 'Anggota',     color: 'from-rose-500 to-pink-600',     photo: '/foto-nisrina.jpeg' },
  { id: 11, name: 'Jonathan',                    role: 'Anggota',     color: 'from-indigo-500 to-blue-600',   photo: '/foto-jonathan.jpeg' },
  { id: 12, name: 'Miya Ayu Lestari',           role: 'Anggota',     color: 'from-purple-500 to-violet-600', photo: '/foto-miya.jpeg' },
  { id: 13, name: 'M. Abdullah Gimnastiar',     role: 'Anggota',     color: 'from-green-500 to-emerald-600', photo: '/foto-abdullah.jpeg' },
  { id: 14, name: 'Dimyati Nur Achmad',         role: 'Anggota',     color: 'from-blue-500 to-cyan-600',     photo: '/foto-dimyati.jpeg' },
  { id: 15, name: 'Fajar Rizky Ramadani',       role: 'Anggota',     color: 'from-amber-500 to-orange-600',  photo: '/foto-fajar.jpeg' },
  { id: 16, name: 'Rangga Maulana Yusuf',       role: 'Anggota',     color: 'from-red-500 to-rose-600',      photo: '/foto-rangga.jpeg' },
